...
public class VikingCatapult {
	...
	private BYFApp game;
	private Animation animFire, animDestroyed;
	...
	public VikingCatapult(Vector2f topLeft, Vector2f bottomRight, Textures tex, BYFApp game) {
		...
		this.game = game;
		this.tex = tex;
		animFire = new Animation(200, tex.vikingCatapultFire);
		animDestroyed = new Animation(200, tex.vikingCatapultDestroyed);
...
//        this.rotateRadian += rotate;
	...
	private BufferedImage getCurrentAnimationFrame() {
		...
		else if(game.getHealth() <= 0)
		{
			...
			return tex.vikingCatapultFire[0];
	}
