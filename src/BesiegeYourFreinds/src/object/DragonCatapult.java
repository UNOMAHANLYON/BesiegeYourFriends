...
public class DragonCatapult {
	...
	public DragonCatapult(Vector2f topLeft, Vector2f bottomRight, Textures tex, BYFApp game) {
		...
		this.game = game;
		this.tex = tex;
		animFire = new Animation(200, tex.dragonCatapultFire);
...
//        this.rotateRadian += rotate;
	...
	private BufferedImage getCurrentAnimationFrame() {
		if(game.getIs_shooting() == true) {
			...
			return tex.dragonCatapultFire[0];
	}
