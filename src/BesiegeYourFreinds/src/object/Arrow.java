...
public class Arrow {
	...
	public Arrow(Vector2f topLeft, Vector2f bottomRight, Textures tex, BYFApp game) {
		...
		this.game = game;
		this.tex = tex;
		animFire = new Animation(200, tex.arrow);
...
//        this.rotateRadian += rotate;
	...
	public void render(Graphics g) {
         ...
         g2d.drawImage(scaledImage, createTransform()/*specific point from catapult*/,  null);
	}
