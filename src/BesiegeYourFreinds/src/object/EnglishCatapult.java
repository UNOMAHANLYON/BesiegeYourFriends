...
public class EnglishCatapult {
	...
	private BYFApp game;
	private Animation animFire, animDamaged;
	...
	public EnglishCatapult(Vector2f topLeft, Vector2f bottomRight, Textures tex, BYFApp game) {
		...
		this.game = game;
		this.tex = tex;
		animFire = new Animation(200, tex.englishCatapultFire);
...
//        this.rotateRadian += rotate;
	...
	private BufferedImage getCurrentAnimationFrame() {
		if(game.getIs_shooting() == true) {
			...
			return tex.englishCatapultFire[0];
	}
